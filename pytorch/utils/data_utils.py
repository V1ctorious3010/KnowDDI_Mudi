...
def process_files_ddi(files, BKG_file, keeptrainone=False):
    ...
    for file_type, file_path in files.items():
        ...
        for triplet in file_data:
            ...
            if triplet[1] not in entity2id:
                entity2id[triplet[1]] = len(entity2id)
    ...
    for (h, t, r) in triplet_kg:
        ...
        kg_triple.append([entity2id[h], entity2id[t], r])
    ...
    for file_type, file_path in files.items():
        ...
        with open(file_path, 'r') as f:
            for lines in f:
                ...
                if keeptrainone:
                    data_mr.append([entity2id[h], entity2id[t], 0])
                else:
                    data_mr.append([entity2id[h], entity2id[t], list_r_onehot])
                data_pol.append(p)
